            ...
            if (option == 1) {
                ...
                while (true) {
                    try {
                        ...
                        System.out.println("Es obligatorio que ingrese una cantidad mayor a 0");
                    } catch (InputMismatchException e) {
                        System.out.println("El numero ingresado no es invalido");
                        input.nextLine();
                    }
                }
                input.nextLine();
                ...
                if (!response.equals("")) {
                    ...
                    if (result.getBaseCode() == null || result.getTargetCode() == null || result.getConversionResult() == 0) {
